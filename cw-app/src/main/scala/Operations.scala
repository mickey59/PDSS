...
object Operations {
  ...
  def sparseMatrixMultiply(A: RDD[MatrixEntry], B: RDD[MatrixEntry]): RDD[MatrixEntry] = {
  ...
  def tensorMultiply(t1: RDD[TensorEntry], t2: RDD[TensorEntry], dimensions: Int): RDD[TensorEntry] = {
